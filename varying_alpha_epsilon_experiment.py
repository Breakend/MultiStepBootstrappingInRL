...
test_rewards[24] = [4, 4, 50]

terminal_states = [24]

obstacles = [[i, j, 0] for i in range(5) for j in range(5)]


obstacles[1*5+1] = [1, 1, 1]
obstacles[2*5+2] = [2, 2, 1]
obstacles[2*5+3] = [2, 3, 1]
obstacles[3*5+0] = [3, 0, 1]
obstacles[4*5+3] = [4, 3, 1]
...
gw = WindyGridCliffMazeWorld(5, test_rewards, terminal_states, traps, start_state, obstacles)
# print test_rewards
